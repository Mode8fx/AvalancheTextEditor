...
def prepareNewTextSequences():
	...
	textSequences[0].addTextBox(TextBox("Waddle Dee 1", 0x1B5BA, 31, 10, 2, 10, 6))
	textSequences[0].textBoxes[0].addLine("Wanna play a game", 3, 11)
	textSequences[0].textBoxes[0].addLine("of Avalanche?", 3, 13)
	textSequences[0].addTextBox(TextBox("Waddle Dee 2", 0x1B5F0, 52, 20, 9, 2, 6))
	...
	textSequences[0].addTextBox(TextBox("Waddle Dee 3", 0x1B64B, 22, 10, 3, 10, 6))
	...
	textSequences[1].addTextBox(TextBox("Bronto Burt 1", 0x1B679, 36, 15, 11, 4, 6))
	...
	textSequences[1].addTextBox(TextBox("Bronto Burt 2", 0x1B6BB, 51, 15, 2, 8, 6))
	...
	textSequences[1].addTextBox(TextBox("Bronto Burt 3", 0x1B70C, 17, 5, 10, 8, 6))
	textSequences[1].textBoxes[2].addLine("Not PLAY. Battle!", 11, 9)

	textSequences.append(TextSequence("Waddle Doo", 100, 30))
	textSequences[2].addTextBox(TextBox("Waddle Doo 1", 0x1B72F, 82, 25, 10, 4, 6))
	...
	textSequences[2].addTextBox(TextBox("Waddle Doo 2", 0x1B7AD, 18, 5, 3, 12, 6))
	textSequences[2].textBoxes[1].addLine("Okay! I'm ready!", 4, 13)

	textSequences.append(TextSequence("Dedede Intro", 162, 50))
	textSequences[3].addTextBox(TextBox("Dedede Intro 1", 0x1B7D1, 76, 25, 7, 2, 6))
	...
	textSequences[3].addTextBox(TextBox("Dedede Intro 2", 0x1B849, 86, 25, 6, 2, 6))
	...
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 1", 0x1B8CD, 31, 10, 10, 6, 6))
	textSequences[4].textBoxes[0].addLine("Hi, Kirby! Want a", 11, 7)
	textSequences[4].textBoxes[0].addLine("bomb sandwich?", 11, 9)
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 2", 0x1B903, 64, 25, 3, 4, 6))
	...
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 3", 0x1B96F, 59, 20, 9, 2, 6))
	...
	textSequences[6].addTextBox(TextBox("Kabu 1", 0x1BA62, 37, 15, 3, 8, 6))
	...
	textSequences[6].addTextBox(TextBox("Kabu 2", 0x1BAA7, 27, 10, 9, 10, 6))
	textSequences[6].textBoxes[1].addLine("Your journey ends", 10, 11)
	textSequences[6].textBoxes[1].addLine("here...", 10, 13)
	textSequences[6].addTextBox(TextBox("Kabu 3", 0x1BADB, 49, 20, 3, 6, 6))
	...
	textSequences[7].addTextBox(TextBox("Broom Hatter 1", 0x1BB31, 49, 15, 8, 8, 6))
	...
	textSequences[7].addTextBox(TextBox("Broom Hatter 2", 0x1BB80, 58, 20, 3, 6, 6))
	...
	textSequences[7].addTextBox(TextBox("Broom Hatter 3", 0x1BBDF, 26, 15, 14, 8, 6))
	...
	textSequences[8].addTextBox(TextBox("Squishy 3", 0x1BCE5, 43, 15, 10, 8, 6))
	...
	textSequences[9].addTextBox(TextBox("Lololo & Lalala 1", 0x1BD2E, 57, 20, 3, 6, 6))
	...
	textSequences[9].addTextBox(TextBox("Lololo & Lalala 2", 0x1BD8E, 43, 15, 11, 8, 6))
	...
	textSequences[11].addTextBox(TextBox("Paint Roller 5", 0x1BF22, 29, 10, 10, 10, 6))
	...
	textSequences[12].addTextBox(TextBox("Heavy Mole 1", 0x1BF56, 59, 20, 11, 6, 6))
	...
	textSequences[12].addTextBox(TextBox("Heavy Mole 2", 0x1BFB8, 71, 25, 3, 4, 6))
	...
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 1", 0x1C02B, 34, 10, 9, 4, 6))
	textSequences[13].textBoxes[0].addLine("We rule both the", 10, 5)
	textSequences[13].textBoxes[0].addLine("night and the day!", 10, 7)
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 2", 0x1C05F, 42, 15, 9, 3, 6, box_w=20))
	...
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 3", 0x1C0A7, 76, 25, 1, 4, 6))
	...
	textSequences[14].addTextBox(TextBox("Kracko 1", 0x1C11F, 65, 20, 9, 2, 6))
	...
	textSequences[14].addTextBox(TextBox("Kracko 2", 0x1C187, 49, 20, 3, 6, 6))
	...
	textSequences[16].addTextBox(TextBox("King Dedede 1", 0x1C2A1, 54, 15, 8, 6, 6))
	...
	textSequences[16].addTextBox(TextBox("King Dedede 2", 0x1C2F0, 36, 10, 8, 6, 6, box_w=21, box_h=8))
	textSequences[16].textBoxes[1].addLine("The Dream Fountain", 9, 7)
	textSequences[16].textBoxes[1].addLine("Cup will be mine!!", 9, 9)
	textSequences[16].addTextBox(TextBox("King Dedede 3", 0x1C32B, 44, 15, 3, 8, 6))
...
def prepareOriginalTextSequences():
	...
	textSequences.append(TextSequence("Bronto Burt", 104, 35))
	textSequences[1].addTextBox(TextBox("Bronto Burt 1", 0x1B679, 36, 15, 11, 4, 6, box_w=17, box_h=8))
	...
	textSequences[1].addTextBox(TextBox("Bronto Burt 2", 0x1B6BB, 51, 15, 2, 8, 6, box_w=21, box_h=8))
	...
	textSequences[1].addTextBox(TextBox("Bronto Burt 3", 0x1B70C, 17, 5, 10, 8, 6, box_w=19, box_h=4))
	textSequences[1].textBoxes[2].addLine("Shut up and play!", 11, 9)

	textSequences.append(TextSequence("Waddle Doo", 100, 30))
	textSequences[2].addTextBox(TextBox("Waddle Doo 1", 0x1B72F, 82, 25, 10, 4, 6, box_w=20, box_h=12))
	...
	textSequences[2].addTextBox(TextBox("Waddle Doo 2", 0x1B7AD, 18, 5, 3, 12, 6, box_w=20, box_h=4))
	textSequences[2].textBoxes[1].addLine("I don't think so!!", 4, 13)

	textSequences.append(TextSequence("Dedede Intro", 162, 50))
	textSequences[3].addTextBox(TextBox("Dedede Intro 1", 0x1B7D1, 76, 25, 7, 2, 6, box_w=19, box_h=12))
	textSequences[3].textBoxes[0].addLine("Congratulations!", 8, 3)
	...
	textSequences[3].addTextBox(TextBox("Dedede Intro 2", 0x1B849, 86, 25, 6, 2, 6, box_w=21, box_h=12))
	...
	textSequences.append(TextSequence("Poppy Bros. Sr.", 154, 55))
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 1", 0x1B8CD, 31, 10, 10, 6, 6, box_w=19, box_h=6))
	textSequences[4].textBoxes[0].addLine("Hi, Kirby! Want a", 11, 7)
	textSequences[4].textBoxes[0].addLine("bomb sandwich?", 11, 9)
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 2", 0x1B903, 64, 25, 3, 4, 6, box_w=20, box_h=12))
	...
	textSequences[4].addTextBox(TextBox("Poppy Bros. Sr. 3", 0x1B96F, 59, 20, 9, 2, 6, box_w=21, box_h=10))
	...
	textSequences.append(TextSequence("Whispy Woods", 87, 30))
	textSequences[5].addTextBox(TextBox("Whispy Woods 1", 0x1B9CF, 61, 20, 1, 6, 6, box_w=20, box_h=10))
	...
	textSequences[5].addTextBox(TextBox("Whispy Woods 2", 0x1BA31, 26, 10, 2, 10, 6, box_w=18, box_h=6))
	textSequences[5].textBoxes[1].addLine("I feel like some", 3, 11)
	textSequences[5].textBoxes[1].addLine("apple pie!", 3, 13)

	textSequences.append(TextSequence("Kabu", 113, 45))
	textSequences[6].addTextBox(TextBox("Kabu 1", 0x1BA62, 37, 15, 3, 8, 6, box_w=17, box_h=8))
	textSequences[6].textBoxes[0].addLine("Who blocked the", 4, 9)
	textSequences[6].textBoxes[0].addLine("path with this", 4, 11)
	textSequences[6].textBoxes[0].addLine("boulder?", 4, 13)
	textSequences[6].addTextBox(TextBox("Kabu 2", 0x1BAA7, 27, 10, 9, 10, 6, box_w=20, box_h=6))
	textSequences[6].textBoxes[1].addLine("Your road to glory", 10, 11)
	textSequences[6].textBoxes[1].addLine("ends here", 10, 13)
	textSequences[6].addTextBox(TextBox("Kabu 3", 0x1BADB, 49, 20, 3, 6, 6, box_w=19, box_h=10))
	textSequences[6].textBoxes[2].addLine("OH!! Hi Kabu,", 4, 7)
	textSequences[6].textBoxes[2].addLine("are you ready for", 4, 9)
	textSequences[6].textBoxes[2].addLine("a game of", 4, 11)
	textSequences[6].textBoxes[2].addLine("Avalanche?", 4, 13)
	...
	textSequences.append(TextSequence("Broom Hatter", 133, 50))
	textSequences[7].addTextBox(TextBox("Broom Hatter 1", 0x1BB31, 49, 15, 8, 8, 6, box_w=21, box_h=8))
	textSequences[7].textBoxes[0].addLine("Oh what a mess!", 9, 9)
	textSequences[7].textBoxes[0].addLine("Must I clean up", 9, 11)
	textSequences[7].textBoxes[0].addLine("this entire forest?", 9, 13)
	textSequences[7].addTextBox(TextBox("Broom Hatter 2", 0x1BB80, 58, 20, 3, 6, 6, box_w=19, box_h=10))
	...
	textSequences[7].addTextBox(TextBox("Broom Hatter 3", 0x1BBDF, 26, 15, 14, 8, 6, box_w=13, box_h=8))
	textSequences[7].textBoxes[2].addLine("Dust, dust,", 15, 9)
	textSequences[7].textBoxes[2].addLine("sweep...", 15, 11)
	textSequences[7].textBoxes[2].addLine("Huh?!??", 15, 13)

	textSequences.append(TextSequence("Squishy", 175, 55))
	textSequences[8].addTextBox(TextBox("Squishy 1", 0x1BC17, 52, 15, 7, 8, 6, box_w=20, box_h=8))
	...
	textSequences[8].addTextBox(TextBox("Squishy 2", 0x1BC69, 80, 25, 3, 4, 6, box_w=21, box_h=12))
	...
	textSequences[8].addTextBox(TextBox("Squishy 3", 0x1BCE5, 43, 15, 10, 8, 6, box_w=19, box_h=8))
	...
	textSequences.append(TextSequence("Lololo & Lalala", 100, 35))
	textSequences[9].addTextBox(TextBox("Lololo & Lalala 1", 0x1BD2E, 57, 20, 3, 6, 6, box_w=21, box_h=10))
	textSequences[9].textBoxes[0].addLine("To get this far you", 4, 7)
	textSequences[9].textBoxes[0].addLine("must have", 4, 9)
	textSequences[9].textBoxes[0].addLine("a-MAZE-ing skill", 4, 11)
	textSequences[9].textBoxes[0].addLine("Tee hee hee!!", 4, 13)
	textSequences[9].addTextBox(TextBox("Lololo & Lalala 2", 0x1BD8E, 43, 15, 11, 8, 6, box_w=18, box_h=8))
	textSequences[9].textBoxes[1].addLine("Oh yeah? Try and", 12, 9)
	textSequences[9].textBoxes[1].addLine("figure your way", 12, 11)
	textSequences[9].textBoxes[1].addLine("out of this!", 12, 13)

	textSequences.append(TextSequence("Bugzzy", 37, 15))
	textSequences[10].addTextBox(TextBox("Bugzzy 1", 0x1BDD7, 18, 5, 7, 10, 6, box_w=20, box_h=4))
	textSequences[10].textBoxes[0].addLine("ROOAAAAAAARRR!!!!!", 8, 11)
	textSequences[10].addTextBox(TextBox("Bugzzy 2", 0x1BDFD, 19, 10, 3, 10, 6, box_w=15, box_h=6))
	textSequences[10].textBoxes[1].addLine("Oh, I'm soooo", 4, 11)
	textSequences[10].textBoxes[1].addLine("scared", 4, 13)

	textSequences.append(TextSequence("Paint Roller", 174, 60))
	textSequences[11].addTextBox(TextBox("Paint Roller 1", 0x1BE27, 36, 10, 9, 10, 6, box_w=20, box_h=6))
	textSequences[11].textBoxes[0].addLine("Let me paint you a", 10, 11)
	textSequences[11].textBoxes[0].addLine("lovely portrait...", 10, 13)
	textSequences[11].addTextBox(TextBox("Paint Roller 2", 0x1BE62, 19, 10, 3, 10, 6, box_w=15, box_h=6))
	textSequences[11].textBoxes[1].addLine("Oh, how sweet", 4, 11)
	textSequences[11].textBoxes[1].addLine("of yo-", 4, 13)
	textSequences[11].addTextBox(TextBox("Paint Roller 3", 0x1BE8C, 33, 10, 10, 10, 6, box_w=19, box_h=6))
	textSequences[11].textBoxes[2].addLine("... of you losing", 11, 11)
	textSequences[11].textBoxes[2].addLine("to me, HA HA HA!", 11, 13)
	textSequences[11].addTextBox(TextBox("Paint Roller 4", 0x1BEC4, 57, 20, 3, 6, 6, box_w=19, box_h=10))
	...
	textSequences[11].addTextBox(TextBox("Paint Roller 5", 0x1BF22, 29, 10, 10, 10, 6, box_w=19, box_h=6))
	textSequences[11].textBoxes[4].addLine("Student? HA!", 11, 11)
	textSequences[11].textBoxes[4].addLine("I am the MASTER!!", 11, 13)

	textSequences.append(TextSequence("Heavy Mole", 130, 45))
	textSequences[12].addTextBox(TextBox("Heavy Mole 1", 0x1BF56, 59, 20, 11, 6, 6, box_w=18, box_h=10))
	textSequences[12].textBoxes[0].addLine("I am Heavy Mole,", 12, 7)
	textSequences[12].textBoxes[0].addLine("watch while I", 12, 9)
	textSequences[12].textBoxes[0].addLine("undermine your", 12, 11)
	textSequences[12].textBoxes[0].addLine("precious dream!!", 12, 13)
	textSequences[12].addTextBox(TextBox("Heavy Mole 2", 0x1BFB8, 71, 25, 3, 4, 6, box_w=21, box_h=12))
	...
	textSequences.append(TextSequence("Mr. Shine & Mr. Bright", 152, 50))
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 1", 0x1C02B, 34, 10, 9, 4, 6, box_w=20, box_h=6))
	textSequences[13].textBoxes[0].addLine("We rule both the", 10, 5)
	textSequences[13].textBoxes[0].addLine("night and the day!", 10, 7)
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 2", 0x1C05F, 42, 15, 9, 3, 6, box_w=20, box_h=8))
	textSequences[13].textBoxes[1].addLine("This leaves no", 10, 4)
	textSequences[13].textBoxes[1].addLine("time for you", 10, 6)
	textSequences[13].textBoxes[1].addLine("Kirby! Be gone!!", 10, 8)
	textSequences[13].addTextBox(TextBox("Mr. Shine & Mr. Bright 3", 0x1C0A7, 76, 25, 1, 4, 6, box_w=19, box_h=12))
	...
	textSequences.append(TextSequence("Kracko", 114, 40))
	textSequences[14].addTextBox(TextBox("Kracko 1", 0x1C11F, 65, 20, 9, 2, 6, box_w=20, box_h=10))
	textSequences[14].textBoxes[0].addLine("KRRR-RACKK!!!!", 10, 3)
	textSequences[14].textBoxes[0].addLine("Dance to my deadly", 10, 5)
	textSequences[14].textBoxes[0].addLine("music, or fry like", 10, 7)
	textSequences[14].textBoxes[0].addLine("a moth! HA HA!!", 10, 9)
	textSequences[14].addTextBox(TextBox("Kracko 2", 0x1C187, 49, 20, 3, 6, 6, box_w=21, box_h=10))
	...
	textSequences.append(TextSequence("Meta Knight", 109, 40))
	textSequences[15].addTextBox(TextBox("Meta Knight 1", 0x1C1DF, 32, 10, 11, 8, 6, box_w=18, box_h=6))
	textSequences[15].textBoxes[0].addLine("None shall pass!", 12, 9)
	textSequences[15].textBoxes[0].addLine("En garde, Kirby!", 12, 11)
	textSequences[15].addTextBox(TextBox("Meta Knight 2", 0x1C216, 21, 10, 3, 10, 6, box_w=15, box_h=6))
	textSequences[15].textBoxes[1].addLine("But I have no", 4, 11)
	textSequences[15].textBoxes[1].addLine("sword!?!", 4, 13)
	textSequences[15].addTextBox(TextBox("Meta Knight 3", 0x1C242, 56, 20, 9, 4, 6, box_w=20, box_h=10))
	...
	textSequences.append(TextSequence("King Dedede", 134, 40))
	textSequences[16].addTextBox(TextBox("King Dedede 1", 0x1C2A1, 54, 15, 8, 6, 6, box_w=21, box_h=8))
	...
	textSequences[16].textBoxes[1].addLine("The Dream Fountain", 9, 7)
	textSequences[16].textBoxes[1].addLine("Cup will be mine!!", 9, 9)
	textSequences[16].addTextBox(TextBox("King Dedede 3", 0x1C32B, 44, 15, 3, 8, 6, box_w=18, box_h=8))
